        ...
        <li class="nav-item">
          ...
          <div class="multi-level collapse " role="list" id="submenu-components" aria-expanded="false">
              <ul class="flex-column nav">
                  ...
                  <li class="nav-item "><a class="nav-link" href="writestatus.html"><span>edit status</span></a></li>

                  <li class="nav-item "><a class="nav-link" href="forms.php"><span>write status</span></a></li>
...
<a class="dropdown-item font-weight-bold" href="#"><span class="fas fa-sign-out-alt text-danger"></span>Logout</a>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-lg-4 col-sm-6">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" name = "firstname"class="form-control" id="email" placeholder="First Name ">  
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="exampleInputIconLeft" placeholder="Last Name" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="password" class="form-control" id="exampleInputIconPassword" placeholder="phone number">
                                            ...
                                            <div class="col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    <label for="birthday">Appointment</label>
                                                    <div class="input-group">
  ...
  <div class="my-4">
                                                    ...
                                                    <textarea class="form-control" placeholder="Enter your message..." id="textarea" cols="10" rows="4" ></textarea>
                                                  </div>
