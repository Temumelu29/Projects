...
<a class="dropdown-item font-weight-bold" href="logout.php"><span class="fas fa-sign-out-alt text-danger"></span>Logout</a>
            ...
            <?php
                ...
                if(count(fetchAll($query))>0){
                    ...
                    <p class="lead text-muted"><?php echo $row['firstname'] ?> is requesting appointment for <?php echo $row['service'] ?> </p> 
                      
                   Appointment date   <p class="lead text-muted"><?php echo $row['date'] ?></p>
