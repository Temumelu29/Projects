...
include "config.php";
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "INSERT INTO `registerduser`(`firstname`, `lastname`, `email`, `password`, `gender`,`role`) VALUES ('$first_name','$last_name','$email','$password','$gender','user')";
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div>
                                                    ...
                                                    <input class="form-control" name="lastname" type="text" placeholder="Also your last name" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                    ...
                                                    <button type="submit" name="submit" class="btn btn-block btn-primary">Save All</button>
                                                </div>
                                            </div>
                                        </div>
